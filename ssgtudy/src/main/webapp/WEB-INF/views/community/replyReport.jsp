...
function sendOk() {
    ...
    f.action = "${pageContext.request.contextPath}/community/replyReport";
    f.submit();
					...
					<tr>
						<td colspan="2" align="left">
							...
							<div id="etc_view" style="display:none;">
								<input type="text" name="reason_etc" id="reason_etc_view" class="form-control" style="width:300px;" placeholder="기타 선택 시 입력해주세요."/>
							</div>
						</td>
					</tr>
			</table>
